...
export const insertProductSchema = z.object({
  ...
  images: z.array(z.string().min(1, "Prodcut must have at least one image")),
  // isFeatured: z.boolean(),
  // banner: z.string().nullable(),
  price: currency,
});

// Schema for updating admin products
export const updateProuctSchema = insertProductSchema.extend({
